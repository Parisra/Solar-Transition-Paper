...
# solar PV
def convert_pv(
    ds, panel, orientation, tracking, dc_ac, trigon_model="simple", clearsky_model="simple"
):
    solar_position = SolarPosition(ds)
    ...
    solar_panel = SolarPanelModel(ds, irradiation, panel, dc_ac)
    return solar_panel


def pv(cutout, panel, orientation, tracking=None, dc_ac=1, clearsky_model=None, **params):
    """
