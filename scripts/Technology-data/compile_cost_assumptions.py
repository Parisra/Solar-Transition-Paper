{
 "cells": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "/home/parisr/miniconda3/envs/pypsa-eur-masters/lib/python3.10/site-packages/openpyxl/styles/stylesheet.py:226: UserWarning: Workbook contains no default style, apply openpyxl's default\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "found  7  excel sheets: \n",
      "*  /home/parisr/projects3/technology-data/inputs/energy_transport_data_sheet_dec_2017.xlsx\n",
      "*  /home/parisr/projects3/technology-data/inputs/data_sheets_for_renewable_fuels.xlsx\n",
      "*  /home/parisr/projects3/technology-data/inputs/technology_data_catalogue_for_energy_storage.xlsx\n",
      "*  /home/parisr/projects3/technology-data/inputs/technology_data_for_el_and_dh.xlsx\n",
      "*  /home/parisr/projects3/technology-data/inputs/technologydatafor_heating_installations_marts_2018.xlsx\n",
      "*  /home/parisr/projects3/technology-data/inputs/technology_data_for_industrial_process_heat.xlsx\n",
      "*  /home/parisr/projects3/technology-data/inputs/technology_data_for_carbon_capture_transport_storage.xlsx\n",
      ...
      "solar-utility in PyPSA corresponds to 22 Utility-scale PV in DEA database.\n",
      "solar-utility single-axis tracking in PyPSA corresponds to 22 Utility-scale PV tracker in DEA database.\n",
      "solar-rooftop residential in PyPSA corresponds to 22 Rooftop PV residential in DEA database.\n",
      "solar-rooftop commercial in PyPSA corresponds to 22 Rooftop PV commercial in DEA database.\n",
      "OCGT in PyPSA corresponds to 52 OCGT - Natural gas in DEA database.\n",
      "CCGT in PyPSA corresponds to 05 Gas turb. CC, steam extract. in DEA database.\n",
      "oil in PyPSA corresponds to 50 Diesel engine farm in DEA database.\n",
      "biomass CHP in PyPSA corresponds to 09c Straw, Large, 40 degree in DEA database.\n",
      "biomass EOP in PyPSA corresponds to 09c Straw, Large, 40 degree in DEA database.\n",
      "biomass HOP in PyPSA corresponds to 09c Straw HOP in DEA database.\n",
      "central coal CHP in PyPSA corresponds to 01 Coal CHP in DEA database.\n",
      "central gas CHP in PyPSA corresponds to 04 Gas turb. simple cycle, L in DEA database.\n",
      "central gas CHP CC in PyPSA corresponds to 04 Gas turb. simple cycle, L in DEA database.\n",
      "central solid biomass CHP in PyPSA corresponds to 09a Wood Chips, Large 50 degree in DEA database.\n",
      "central solid biomass CHP CC in PyPSA corresponds to 09a Wood Chips, Large 50 degree in DEA database.\n",
      "central solid biomass CHP powerboost CC in PyPSA corresponds to 09a Wood Chips, Large 50 degree in DEA database.\n",
      "central air-sourced heat pump in PyPSA corresponds to 40 Comp. hp, airsource 3 MW in DEA database.\n",
      "central ground-sourced heat pump in PyPSA corresponds to 40 Absorption heat pump, DH in DEA database.\n",
      ...
      "direct firing gas in PyPSA corresponds to 312.a Direct firing Natural Gas in DEA database.\n",
      "direct firing gas CC in PyPSA corresponds to 312.a Direct firing Natural Gas in DEA database.\n",
      "direct firing solid fuels in PyPSA corresponds to 312.b Direct firing Sold Fuels in DEA database.\n",
      "direct firing solid fuels CC in PyPSA corresponds to 312.b Direct firing Sold Fuels in DEA database.\n",
      "decentral ground-sourced heat pump in PyPSA corresponds to 207.7 Ground source existing in DEA database.\n",
      "decentral air-sourced heat pump in PyPSA corresponds to 207.3 Air to water existing in DEA database.\n",
      "central water tank storage in PyPSA corresponds to 140 PTES seasonal in DEA database.\n",
      "fuel cell in PyPSA corresponds to 12 LT-PEMFC CHP in DEA database.\n",
      "hydrogen storage underground in PyPSA corresponds to 151c Hydrogen Storage - Caverns in DEA database.\n",
      "hydrogen storage tank type 1 including compressor in PyPSA corresponds to 151a Hydrogen Storage - Tanks in DEA database.\n",
      "micro CHP in PyPSA corresponds to 219 LT-PEMFC mCHP - natural gas in DEA database.\n",
      "biogas in PyPSA corresponds to 81 Biogas, Basic plant, small in DEA database.\n",
      "biogas CC in PyPSA corresponds to 81 Biogas, Basic plant, small in DEA database.\n",
      "biogas upgrading in PyPSA corresponds to 82 Upgrading 3,000 Nm3 per h in DEA database.\n",
      "battery in PyPSA corresponds to 180 Lithium Ion Battery in DEA database.\n",
      "industrial heat pump medium temperature in PyPSA corresponds to 302.a High temp. hp Up to 125 C in DEA database.\n",
      "industrial heat pump high temperature in PyPSA corresponds to 302.b High temp. hp Up to 150 in DEA database.\n",
      "electric boiler steam in PyPSA corresponds to 310.1 Electric boiler steam   in DEA database.\n",
      "gas boiler steam in PyPSA corresponds to 311.1c Steam boiler Gas in DEA database.\n",
      "solid biomass boiler steam in PyPSA corresponds to 311.1e Steam boiler Wood in DEA database.\n",
      "solid biomass boiler steam CC in PyPSA corresponds to 311.1e Steam boiler Wood in DEA database.\n",
      "biomass boiler in PyPSA corresponds to 204 Biomass boiler, automatic in DEA database.\n",
      "electrolysis in PyPSA corresponds to 86 AEC 100 MW in DEA database.\n",
      "direct air capture in PyPSA corresponds to 403.a Direct air capture in DEA database.\n",
      "biomass CHP capture in PyPSA corresponds to 401.a Post comb - small CHP in DEA database.\n",
      "cement capture in PyPSA corresponds to 401.c Post comb - Cement kiln in DEA database.\n",
      "BioSNG in PyPSA corresponds to 84 Gasif. CFB, Bio-SNG in DEA database.\n",
      "BtL in PyPSA corresponds to 85 Gasif. Ent. Flow FT, liq fu  in DEA database.\n",
      "biomass-to-methanol in PyPSA corresponds to 97 Methanol from biomass gasif. in DEA database.\n",
      "biogas plus hydrogen in PyPSA corresponds to 99 SNG from methan. of biogas in DEA database.\n",
      "methanolisation in PyPSA corresponds to 98 Methanol from hydrogen in DEA database.\n",
      "Fischer-Tropsch in PyPSA corresponds to 102 Hydrogen to Jet in DEA database.\n",
      "central hydrogen CHP in PyPSA corresponds to 12 LT-PEMFC CHP in DEA database.\n",
      "Haber-Bosch in PyPSA corresponds to 103 Hydrogen to Ammonia in DEA database.\n",
      "air separation unit in PyPSA corresponds to 103 Hydrogen to Ammonia in DEA database.\n",
      "waste CHP in PyPSA corresponds to 08 WtE CHP, Large, 50 degree in DEA database.\n",
      "waste CHP CC in PyPSA corresponds to 08 WtE CHP, Large, 50 degree in DEA database.\n"
     ]
    },
    {
     "name": "stderr",
     "output_type": "stream",
     "text": [
      "/tmp/ipykernel_475/3233564904.py:765: FutureWarning: The default value of regex will change from True to False in a future version.\n",
      "  tech_data.unit = tech_data.unit.str.replace(\"mill. EUR\", \"EUR\")\n",
      "/tmp/ipykernel_475/3233564904.py:863: FutureWarning: The default value of regex will change from True to False in a future version.\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "check efficiency:  Fischer-Tropsch   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  Haber-Bosch   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check VOM:  air separation unit   Variable O&M    EUR/t_N2\n",
      "Name: unit, dtype: object\n",
      "check efficiency:  air separation unit   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  battery storage   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  biogas   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  biogas CC   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  biogas plus hydrogen   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  biogas upgrading   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check investment:  biomass CHP capture   Specific investment    t CO2 output/hour\n",
      "Name: unit, dtype: object\n",
      "check VOM:  biomass CHP capture   Variable O&M    EUR/t CO2 output\n",
      "Name: unit, dtype: object\n",
      "check efficiency:  biomass CHP capture   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check investment:  cement capture   Specific investment    t CO2 output/hour\n",
      "Name: unit, dtype: object\n",
      "check VOM:  cement capture   Variable O&M    EUR/t CO2 output\n",
      "Name: unit, dtype: object\n",
      "check efficiency:  cement capture   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "---------------------------------------\n",
      "check efficiency:  decentral gas boiler connection   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check investment:  direct air capture   Specific investment    t CO2 output/hour\n",
      "Name: unit, dtype: object\n",
      "check efficiency:  direct air capture   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  electrolysis   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "---------------------------------------\n",
      "---------------------------------------\n",
      "check FOM:  methanolisation   Fixed O&M    MW-methanol/year\n",
      "Fixed O&M      1,000 TPD/year\n",
      "Name: unit, dtype: object\n",
      "check efficiency:  methanolisation   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check VOM:  offwind   Variable O&M [EUR/MWh_e, 2020]    EUR/MWh_e, 2020\n",
      "Name: unit, dtype: object\n",
      "check efficiency:  offwind   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  onwind   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  solar-rooftop commercial   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  solar-rooftop residential   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  solar-utility   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n",
      "check efficiency:  solar-utility single-axis tracking   Series([], Name: unit, dtype: object)\n",
      "---------------------------------------\n"
     ]
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "/tmp/ipykernel_475/3233564904.py:1898: FutureWarning: In a future version, the Index constructor will not infer numeric dtypes when passed object-dtype sequences (matching Series behavior)\n",
      "  SMR_df.loc[(\"SMR\", \"investment\"), years] = SMR\n",
      "/tmp/ipykernel_475/3233564904.py:1899: FutureWarning: In a future version, the Index constructor will not infer numeric dtypes when passed object-dtype sequences (matching Series behavior)\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Add energy storage database compiled for year 2020\n"
     ]
    },
    {
     "name": "stderr",
    ...
    },
    {
     ...
     "text": [
      ...
      "MultiIndex([(                            'biogas',          'fuel'),\n",
      "            (                   'central gas CHP',           'c_v'),\n",
      "            (                   'central gas CHP',   'p_nom_ratio'),\n",
      "            (         'central solid biomass CHP',   'p_nom_ratio'),\n",
      "            (   'decentral air-sourced heat pump', 'discount rate'),\n",
      "            (              'decentral gas boiler', 'discount rate'),\n",
      "            ('decentral ground-sourced heat pump', 'discount rate'),\n",
      ...
      "old c_v and c_b values are assumed where given\n"
     ]
    },
    {
     "name": "stderr",
     "output_type": "stream",
     "text": [
      "/tmp/ipykernel_475/3233564904.py:2370: DeprecationWarning: In a future version, `df.iloc[:, i] = newvals` will attempt to set the values inplace instead of always setting a new array. To retain the old behavior, use either `df[df.columns[i]] = newvals` or, if columns are non-unique, `df.isetitem(i, newvals)`\n",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Add energy storage database compiled for year 2025\n"
     ]
    },
    {
     "name": "stderr",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Add energy storage database compiled for year 2030\n"
     ]
    },
    {
     "name": "stderr",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Add energy storage database compiled for year 2035\n"
     ]
    },
    {
     "name": "stderr",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Add energy storage database compiled for year 2040\n"
     ]
    },
    {
     "name": "stderr",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Add energy storage database compiled for year 2045\n"
     ]
    },
    {
     "name": "stderr",
    ...
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "Add energy storage database compiled for year 2050\n"
     ]
    },
    {
     "name": "stderr",
  ...
  {
   "cell_type": "markdown",
   "id": "91c6f90d-6ca4-4881-bc9d-e32490118523",
   "metadata": {},
   "source": [
    "## test solar cost modification"
   ]
  }
 ],
 "metadata": {
