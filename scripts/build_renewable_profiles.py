...
if __name__ == "__main__":
    ...
    if 'solar' in snakemake.wildcards.technology and 'inv' in snakemake.wildcards.technology:
       solar_tech = snakemake.wildcards.technology.split('-inv')[0]
       params = snakemake.params.renewable[solar_tech]    ##al the parameters same as solar or solar hsat, except for dc/ac ratio, TODO : change potential here too instead of in prepare.
       resource = params["resource"]  # pv panel params / wind turbine params
       resource['dc_ac'] = snakemake.wildcards.technology.split('inv-')[1]  ##not a good approach, but saves adding each tech to config 
    else:     
